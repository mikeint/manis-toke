        ...
        return (
            <React.Fragment>
                <header className="navbar">
                    <Link to="/hub"><div className="topTitle" onClick={this.resetCardId}>Hub</div></Link>
                    <ul>
                        <li><div className="admNavBtn" onClick={this.handleLogout}><a target="_blank">Log Out</a></div></li>
                        {this.props.deleteButton ? <li><div className="removeFullCarButton" onClick={this.props.deleteFullCard}>REMOVE CARD</div></li>: ""}
                        {!this.props.deleteButton ? 
                            <li><Link to="/addCard"><div onClick={()=>this.addTempCar} className="admNavBtn">Add Card</div></Link></li>
                            : 
                        ""}
                    </ul>
                </header>
